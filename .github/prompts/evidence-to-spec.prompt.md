...
description: Synthesize synthetic product evidence into a reviewable Saved Searches specification update.
argument-hint: "[scope or decision to synthesize]"
agent: product-strategist
---

Synthesize `${input:focus:Scope or decision to synthesize}` into a product-spec proposal using [the evidence index](../../product/evidence/README.md), [shopper/support signals](../../product/evidence/shopper-research-signals.md), [usage evidence](../../product/evidence/usage-analytics.json), [market notes](../../product/evidence/market-notes.md), [current spec](../../product/saved-searches-spec.md), and [roadmap](../../product/roadmap.json).
